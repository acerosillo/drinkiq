                        ...
                        <div className="row">
                          <div className="resultsHeader__right">
                            <div className="content__wrap">
                              ...
                              <p>
                                Whenever you are thinking of having a drink or
                                buying alcohol, particularly when travelling, it
                                is important to feel well informed about the
                                impact of drinking alcohol in any amount
                              </p>
                              <p>All journeys should be safe</p>
                              <p>
                                All holidays should be ones to remember
                                #aholidaytoremember
                              </p>
                              <p>
                                If you would like more information you can go
                                to:
                              </p>

                              <p>
                                <a
                                  href="http://www.drinkiq.com"
                                  className="btn btn-white"
                                  data-galabel="www.drinkiq.com"
                                >
                                  www.drinkiq.com
                                </a>
                              </p>
                ...
                <div className="content__right dgtheme--green">
                  ...
                  <div className="splash__content">
                    <h1 className="splash__title">
                      Take this quick test to find out what you know about
                      drinking alcohol
                    </h1>
              ...
              <div className="col-lg-5 col-xl-5 col-md-5 col-sm-12 order-first">
                <div className="row">
                  <div className="content__left">
                    <img
                      src={"./randImg/LandingHomepage.webp"}
                      alt="img"
                      loading="lazy"
                    />
                  </div>
